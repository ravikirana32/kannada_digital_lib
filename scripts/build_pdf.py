...
ROOT=Path(__file__).resolve().parents[1]; FONT=ROOT/"books/sarvajna/assets/NotoSansKannada-Regular.ttf"
if not FONT.exists(): raise SystemExit("Missing Kannada font: books/sarvajna/assets/NotoSansKannada-Regular.ttf")
...
story=[Paragraph("ಸರ್ವಜ್ಞ ಸಮಗ್ರ ತ್ರಿಪದಿಗಳು",styles["Title"]),Paragraph("ಮೂಲ ಕನ್ನಡ • ಭಾವಾರ್ಥ • ಜೀವನ ಸಂದೇಶ",styles["Normal"]),Spacer(1,14)]
rows=[]
...
SimpleDocTemplate(str(OUT),pagesize=A4).build(story); print("PDF generated:",OUT)
