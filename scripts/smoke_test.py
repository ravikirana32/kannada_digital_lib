...
required=[
 ...
 "scripts/validate_all.py","scripts/build_book.py","scripts/build_docx.py",
 "scripts/build_pdf.py","scripts/build_epub.py","scripts/build_social.py",
 "website/package.json","website/src/App.jsx","admin/README.md"
]
